...
export class StudentDetailComponent extends PersonDetailComponent {
  ...
  constructor(studentService: StudentService, professorService: ProfessorService, private professorStudentLinkService: ProfessorStudentLinkService, toastr: ToastrService) {
    super(studentService, professorService, toastr);
  }

  isPersonAssigned = (parentPersonId: number, personId: number): boolean => {
    return this.professorStudentLinkService.studentHasProfessor(parentPersonId, personId);
  }
}
